...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        CreateWindow(L"LISTBOX", L"", WS_VISIBLE | WS_CHILD | WS_BORDER | LBS_STANDARD | LBS_NOINTEGRALHEIGHT | LBS_WANTKEYBOARDINPUT, 10, 50, 500, 300, hWnd, (HMENU)1, NULL, NULL);

        CreateWindow(L"BUTTON", L"Обновить список", WS_VISIBLE | WS_CHILD, 10, 10, 150, 30, hWnd, (HMENU)2, NULL, NULL);
        break;
    ...
    case WM_COMMAND:
        {
            ...
            {
            case 2: {
                HWND hWndListBox = GetDlgItem(hWnd, 1);
                ListProcesses(hWndListBox);
                break;
            }
            case IDM_ABOUT:
